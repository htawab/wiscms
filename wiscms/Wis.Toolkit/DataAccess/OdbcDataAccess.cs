//------------------------------------------------------------------------------
// <copyright file="OdbcDataAccess.cs" company="Oriental Everwisdom">
...
{
	/// <summary>
	/// 用于支持 ODBC 的数据库的数据库访问实现类。
	/// </summary>
	public sealed class OdbcDataAccess : AbstractDataAccess
	{
		#region Constructor
		...
		public OdbcDataAccess(OdbcConnection connection)
		{
		...
		private OdbcTransaction _Transaction = null;
		...
		public override IDataReader ExecuteReader(CommandType commandType, string commandText, IDataParameter[] commandParameterCollection)
		{
			OdbcCommand command = new OdbcCommand();
			PrepareCommand(command, commandType, commandText, commandParameterCollection);
			OdbcDataReader oleDbDataReader = command.ExecuteReader();
			command.Parameters.Clear();
		...
		/// <param name="commandText"></param>
		/// <param name="commandParameterCollection"></param>
		private void PrepareCommand(OdbcCommand command, CommandType commandType, string commandText, IDataParameter[] commandParameterCollection)
		{
