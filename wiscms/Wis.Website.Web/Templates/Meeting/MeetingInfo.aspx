<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeetingInfo.aspx.cs" Inherits="Wis.Website.Web.Templates.MeetingInfo" %>
...
<body>
    ...
    <div class="main">
        <div class="left mgnBot">
            <div class="position">
                铁东教育 &gt; 教育动态</div>
            <h1 id="titleId" runat="server">
                第二十九中学跆拳道道取得骄人战绩</h1>
            <div class="h1bot">
                <span>浏览人数：328</span>2008-12-30 &nbsp;&nbsp;刘浩浩</div>
            <div class="content">
            </div>
            <div class="pinglun">
                <a href="#" title="查看所有评论" class="flright">查看所有评论</a>当前共有 <a href="#" title="查看所有评论">
                    78</a> 条评论</div>
            <div class="pinglun">
                标题：<input type="text" />
                <br />
                内容：<textarea rows="4"></textarea><br />
                <input type="button" value="提交评论" class="plbtn1" /><input type="button" value="取消重置"
                    class="plbtn" />
            </div>
        </div>
        <div class="right">
