...
<body style="background: #d6e7f7"><form id="form1" runat="server">
    <div>
        <div class="position">当前位置：<asp:HyperLink ID="HyperLinkCategory" runat="server"></asp:HyperLink> » 录入内容</div>
        <div class="add_step">
            <ul>
                <li>第一步：选择分类</li>
        ...
        <div class="add_main">
            ...
            <div id="divTag">
                <label class="articleLabel" title="不同于一般的目录结构的分类方法，以较少的代价细化分类">主 题：</label><input id="Tags" type="text" size="30" name="Tags" value="" /> 主题用空格隔开
                <br />
            </div>
        </div>
