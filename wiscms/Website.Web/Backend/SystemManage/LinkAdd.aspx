<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkAdd.aspx.cs" Inherits="Wis.Website.Web.Backend.SystemManage.LinkAdd" %>
...
<body>
    ...
    <div class="right" id="divright">
        ...
        <div class="schBox">
            <label>
                名称：</label><input type="text" id="LinkName" runat="server" maxlength="20" /><br />
            <label>
...
<%=ViewState["javescript"] %>
    function checkNews() {
//        if(!document.getElementById("alllanmu").checked)
//        {
