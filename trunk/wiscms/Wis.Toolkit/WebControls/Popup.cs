//------------------------------------------------------------------------------
// <copyright file="Popup.cs" company="Oriental Everwisdom">
...
namespace Wis.Toolkit.WebControls
{
  ...
  /// </summary>
  [DefaultProperty("Message"),ToolboxData("<{0}:Popup runat=server></{0}:Popup>")]
  [Designer(typeof(PopupDesigner))]
  public class Popup : System.Web.UI.WebControls.WebControl, IPostBackEventHandler
  {
  ...
  /// </summary>
  public class PopupDesigner : ControlDesigner
  {
    ...
    public override string GetDesignTimeHtml()
    {
      try
      {
        return ((Popup)Component).GetDesignCode(); 
      }
      catch(Exception er)
      {
