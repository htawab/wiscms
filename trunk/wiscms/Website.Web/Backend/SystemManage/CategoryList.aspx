<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryList.aspx.cs" Inherits="Wis.Website.Web.Backend.SystemManage.CategoryList" %>
...
<body onload="WebsiteObj.System.CategoryLoadData(1)">
    <form id="form1" runat="server">
    <div class="right" id="divright">
        <div class="position">
            栏目管理 » <span class="red" runat="server" id="daohang"></span>
        </div>
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td width="46%">
                    ...
                    <div class="command" onclick="WebsiteObj.System.CategoryAdd()">
                        添加栏目</div>
