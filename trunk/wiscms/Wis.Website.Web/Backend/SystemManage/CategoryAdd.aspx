<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryAdd.aspx.cs" Inherits="Wis.Website.Web.Backend.SystemManage.CategoryAdd" %>
...
<body>
    ...
    <div class="right" id="divright">
        <div class="position">
            栏目管理 » <span class="red">栏目添加</span></div>
        <div class="addBox">
            <label class="long">
                栏目名称：</label><input type="text" id="CategoryName" runat="server" maxlength="20" /><br />
            <label class="long">
                父栏目：</label><input type="text" id="ParentGuid" name="ParentGuid" style="display: none;" runat="server" maxlength="20" /><input type="text" id="ParentName" ContentEditable="false"  runat="server" maxlength="20" /><img src="../../images/folder.gif" alt="选择已有标签"
            ...
            <br />
            <label class="long">
                新闻模板路径：</label><input type="text" runat="server" ContentEditable="false" id="NewsTemplatePath" size="60" name="NewsTemplatePath" /><img
                    src="../../sysImages/folder/s.gif" alt="" border="0" style="cursor: pointer;"
