<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryAddNew.aspx.cs" Inherits="Wis.Website.Web.Backend.CategoryAddNew" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>添加分类 - 常智内容管理系统</title>
...
<body style="background: #d6e7f7">
    ...
    <div class="listBox">
        <div class="userEdit">
            ...
            <div class="borBot">
                <label>分类序号：</label>
                <asp:TextBox ID="TextBoxCategoryRank" runat="server"></asp:TextBox>
                <span>分类排序号（阿拉伯数字）</span>
            </div>
        </div>
    </div>
