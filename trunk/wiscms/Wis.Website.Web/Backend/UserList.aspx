...
<body style="background:#d6e7f7">
    ...
    <div class="rightBox_in"><label>用户名称：</label><input type="text" /><input type="image" style="height:auto;" src="images/schbtn.gif" /><a href="UserAddNew.aspx">新增用户</a><div class="clear"></div></div>
