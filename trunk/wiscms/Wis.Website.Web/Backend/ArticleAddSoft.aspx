...
<body style="background: #d6e7f7"><form id="form1" runat="server">
    <div>
        ...
        <div class="add_main">
            ...
            <div><label>软件授权：</label><INPUT size="10" name="Copyright" value="共享版" /> <SELECT onchange="impower.value=this.value;" name="SelectCopyright"> <OPTION value="共享版">选择授权方式</OPTION> <OPTION value="共享版">共享版</OPTION> <OPTION value="免费版">免费版</OPTION> <OPTION value="自由版">自由版</OPTION> <OPTION value="试用版">试用版</OPTION> <OPTION value="演示版">演示版</OPTION> <OPTION value="商业版">商业版</OPTION></SELECT></div>
            <div><label>软件运行环境：</label><INPUT size="60" id="OperatingSystem" name="OperatingSystem" value="Win9X/2000/XP/2003/" /><BR /><A href='javascript:ToOperatingSystem("Win9X/")'><U>Win9X/</U></A> | <A href='javascript:ToOperatingSystem("ME/")'><U>ME/</U></A> | <A href='javascript:ToOperatingSystem("NT/")'><U>NT/</U></A> | <A href='javascript:ToOperatingSystem("2000/")'><U>2000/</U></A> | <A href='javascript:ToOperatingSystem("XP/")'><U>XP/</U></A> | <A href='javascript:ToOperatingSystem("2003/")'><U>2003/</U></A> | <A href='javascript:ToOperatingSystem("Vista/")'><U>Vista/</U></A> | <A href='javascript:ToOperatingSystem("Linux/")'><U>Linux/</U></A> | <A href='javascript:ToOperatingSystem("Unix/")'><U>Unix/</U></A> | <A href='javascript:ToOperatingSystem("Mac/")'><U>Mac/</U></A></div>
            ...
            <div><label>插件情况：</label><SELECT name="Plugin"><OPTION value="1">无插件-无病毒</OPTION> <OPTION value="2">有插件-可选择</OPTION> <OPTION value="3">凝有毒-未确认</OPTION> <OPTION value="4">有插件-无选择</OPTION> <OPTION value="5">有病毒-已确认</OPTION> <OPTION value="6">尚未认证</OPTION> <OPTION value="7">未通过-暂停下载</OPTION></SELECT></div>
            <div>
                <label>软件预览图：</label>
