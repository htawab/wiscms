<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlogArticalList.aspx.cs" Inherits="Wis.Website.Web.Backend.BlogArticalList" %>
...
<body style="background:#d6e7f7">
    ...
    <div class="rightBox_in"><label>博客标题：</label><input type="text" /><input type="image" style="height:auto;" src="images/schbtn.gif" /><a href="BlogArticalAdd.htm">发表博客</a><div class="clear"></div></div>
